...
# 
#
#       Mixing Model for Heat Based IWPVP w/ Nonlinear Fit + Rolling Average + Baseline Correction for Multi-Channel Resistor + Forcing to 0
...
#Edit line 55 to select first and last data point of the range selected
